...
def register_views(app):
    ...
    @app.route('/game/unregister<int:game_id>', methods=['PATCH'])
    ...
    def unregister(jwt, game_id):
        ...
        if player_id is None:
            # this is for testing @TODO write some kind of error
            player_id = int(request.args['user_id'])


        registration = Registration.query.filter(game_id=game_id, player_id=player_id).one_or_none()
